  ...
  return {
    ...
    get: async id => {
      try {
        const res = await superagent
          .get(
            `${baseUrl}/${constants.VERSION}/${constants.LOCATIONS}/${id}`
          )
          .set("Authorization", `Bearer ${accessToken}`)
          .set("Content-Type", "application/json");
        if (res && res.ok) {
    ...
    getDiscount: async (location_id, discount_id) => {
      try {
        const res = await superagent
          .get(
            `${baseUrl}/${constants.VERSION}/${constants.LOCATIONS}/${location_id}/${constants.DISCOUNTS}/${discount_id}`
          )
          .set("Authorization", `Bearer ${accessToken}`)
          .set("Content-Type", "application/json");
        if (res && res.ok) {
    ...
    getDrawer: async (location_id, drawer_id) => {
      try {
        const res = await superagent
          .get(
            `${baseUrl}/${constants.VERSION}/${constants.LOCATIONS}/${location_id}/${constants.DRAWERS}/${drawer_id}`
          )
          .set("Authorization", `Bearer ${accessToken}`)
          .set("Content-Type", "application/json");
        if (res && res.ok) {
    ...
    getExtraCharge: async (location_id, extra_charge_id) => {
      try {
        const res = await superagent
          .get(
            `${baseUrl}/${constants.VERSION}/${constants.LOCATIONS}/${location_id}/${constants.EXTRA_CHARGES}/${extra_charge_id}`
          )
          .set("Authorization", `Bearer ${accessToken}`)
          .set("Content-Type", "application/json");
        if (res && res.ok) {
    ...
    getItem: async (location_id, item_id) => {
      try {
        const res = await superagent
          .get(
            `${baseUrl}/${constants.VERSION}/${constants.LOCATIONS}/${location_id}/${constants.ITEMS}/${item_id}`
          )
          .set("Authorization", `Bearer ${accessToken}`)
          .set("Content-Type", "application/json");
        if (res && res.ok) {
    ...
    getOrderOptions: async (location_id, order_option_id) => {
      try {
        const res = await superagent
          .get(
            `${baseUrl}/${constants.VERSION}/${constants.LOCATIONS}/${location_id}/${constants.ORDER_OPTIONS}/${order_option_id}`
          )
          .set("Authorization", `Bearer ${accessToken}`)
          .set("Content-Type", "application/json");
        if (res && res.ok) {
    ...
    getRegister: async (location_id, register_id) => {
      try {
        const res = await superagent
          .get(
            `${baseUrl}/${constants.VERSION}/${constants.LOCATIONS}/${location_id}/${constants.REGISTERS}/${register_id}`
          )
          .set("Authorization", `Bearer ${accessToken}`)
          .set("Content-Type", "application/json");
        if (res && res.ok) {
    ...
    getSale: async (location_id, sale_id) => {
      try {
        const res = await superagent
          .get(
            `${baseUrl}/${constants.VERSION}/${constants.LOCATIONS}/${location_id}/${constants.SALES}/${sale_id}`
          )
          .set("Authorization", `Bearer ${accessToken}`)
          .set("Content-Type", "application/json");
        if (res && res.ok) {
    ...
    listRefunds: async (location_id, sale_id) => {
      try {
        const res = await superagent
          .get(
            `${baseUrl}/${constants.VERSION}/${constants.LOCATIONS}/${location_id}/${constants.SALES}/${sale_id}/${constants.REFUNDS}`
          )
          .set("Authorization", `Bearer ${accessToken}`)
          .set("Content-Type", "application/json");
        if (res && res.ok) {
    ...
    getTab: async (location_id, tab_id) => {
      try {
        const res = await superagent
          .get(
            `${baseUrl}/${constants.VERSION}/${constants.LOCATIONS}/${location_id}/${constants.TABS}/${tab_id}`
          )
          .set("Authorization", `Bearer ${accessToken}`)
          .set("Content-Type", "application/json");
        if (res && res.ok) {
    ...
    getTabCategory: async (location_id, tab_cat_id) => {
      try {
        const res = await superagent
          .get(
            `${baseUrl}/${constants.VERSION}/${constants.LOCATIONS}/${location_id}/${constants.TABS}/${constants.CATEGORIES}/${tab_cat_id}`
          )
          .set("Authorization", `Bearer ${accessToken}`)
          .set("Content-Type", "application/json");
        if (res && res.ok) {
    ...
    previewTab: async (location_id, payload) => {
      try {
        const res = await superagent
          .post(
            `${baseUrl}/${constants.VERSION}/${constants.LOCATIONS}/${location_id}/${constants.TABS}/${constants.PREVIEW_TAB}`
          )
          .set("Authorization", `Bearer ${accessToken}`)
          .set("Content-Type", "application/json")
          .send(payload);
    ...
    createTab: async (location_id, payload) => {
      try {
        const res = await superagent
          .post(
            `${baseUrl}/${constants.VERSION}/${constants.LOCATIONS}/${location_id}/${constants.TABS}`
          )
          .set("Authorization", `Bearer ${accessToken}`)
          .set("Content-Type", "application/json")
          .send(payload);
    ...
    getTabTemplate: async (location_id, tab_temp_id) => {
      try {
        const res = await superagent
          .get(
            `${baseUrl}/${constants.VERSION}/${constants.LOCATIONS}/${location_id}/${constants.TABS}/${constants.TEMPLATES}/${tab_temp_id}`
          )
          .set("Authorization", `Bearer ${accessToken}`)
          .set("Content-Type", "application/json");
        if (res && res.ok) {
    ...
    assignTabPickup: async (location_id, tab_id, payload) => {
      try {
        const res = await superagent
          .post(
            `${baseUrl}/${constants.VERSION}/${constants.LOCATIONS}/${location_id}/${constants.TABS}/${tab_id}/${constants.ASSIGN_PICKUP}`
          )
          .set("Authorization", `Bearer ${accessToken}`)
          .set("Content-Type", "application/json")
          .send(payload);
    ...
    unassignTabPickup: async (location_id, tab_id, payload) => {
      try {
        const res = await superagent
          .post(
            `${baseUrl}/${constants.VERSION}/${constants.LOCATIONS}/${location_id}/${constants.TABS}/${tab_id}/${constants.UNASSIGN_PICKUP}`
          )
          .set("Authorization", `Bearer ${accessToken}`)
          .set("Content-Type", "application/json")
          .send(payload);
    ...
    cancelTab: async (location_id, tab_id, payload) => {
      try {
        const res = await superagent
          .post(
            `${baseUrl}/${constants.VERSION}/${constants.LOCATIONS}/${location_id}/${constants.TABS}/${tab_id}/${constants.CANCEL}`
          )
          .set("Authorization", `Bearer ${accessToken}`)
          .set("Content-Type", "application/json")
          .send(payload);
